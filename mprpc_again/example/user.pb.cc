...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginResponse, suc_),
  ~0u,  // no _has_bits_
...
void LoginResponse::SharedCtor() {
  ...
  ::memset(&result_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&suc_) -
      reinterpret_cast<char*>(&result_)) + sizeof(suc_));
}
...
::PROTOBUF_NAMESPACE_ID::uint8* LoginResponse::_InternalSerialize(
  ...
  if (this->suc() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(2, this->_internal_suc(), target);
  }
