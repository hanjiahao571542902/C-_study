...
// bool suc = 2;
inline void LoginResponse::clear_suc() {
  suc_ = false;
}
inline bool LoginResponse::_internal_suc() const {
  return suc_;
}
inline bool LoginResponse::suc() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponse.suc)
  return _internal_suc();
}
inline void LoginResponse::_internal_set_suc(bool value) {
  
  suc_ = value;
}
inline void LoginResponse::set_suc(bool value) {
  _internal_set_suc(value);
  // @@protoc_insertion_point(field_set:fixbug.LoginResponse.suc)
}
