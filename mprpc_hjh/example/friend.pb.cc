...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsResponse, sucess_),
...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\0142a\n\016FriendsService\022O\n\016GetFriendLists\022\035."
  "fixbug.GetFriendListsRequest\032\036.fixbug.Ge"
  "tFriendListsResponseB\003\200\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_friend_2eproto = {
  &descriptor_table_friend_2eproto_initialized, descriptor_table_protodef_friend_2eproto, "friend.proto", 313,
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* FriendsService::descriptor() {
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* FriendsService::GetDescriptor() {
  return descriptor();
}

void FriendsService::GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void FriendsService::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendsService::GetRequestPrototype(
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendsService::GetResponsePrototype(
    const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
...
FriendsService_Stub::FriendsService_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel)
...
void FriendsService_Stub::GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
