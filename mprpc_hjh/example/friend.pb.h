...
class FriendsService : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
...
class FriendsService_Stub : public FriendsService {
 public:
  FriendsService_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  FriendsService_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
...
// bool sucess = 2;
inline void GetFriendListsResponse::clear_sucess() {
  sucess_ = false;
}
inline bool GetFriendListsResponse::_internal_sucess() const {
  return sucess_;
}
inline bool GetFriendListsResponse::sucess() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.sucess)
  return _internal_sucess();
}
inline void GetFriendListsResponse::_internal_set_sucess(bool value) {
  
  sucess_ = value;
}
inline void GetFriendListsResponse::set_sucess(bool value) {
  _internal_set_sucess(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListsResponse.sucess)
}
